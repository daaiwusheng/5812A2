...
public:
    ...
    virtual bool scatter(const Ray& ray_in, HitRecord& rec,
                         Cartesian3& _albedo, Ray& scattered, double& proDenF)const;
    ...
    virtual double scattering_proDenF(const Ray& ray_in, const HitRecord& rec, const Ray& scattered) const;

    //if the material is a light source, we need to implement this function.
    //via this function, we can get the emitted Ray color.
    virtual Cartesian3 emits(const Ray& ray_in, const HitRecord& rec,
                             double u, double v,const Cartesian3& p) const;
};
...
public:
    ...
    virtual bool scatter(const Ray& ray_in, HitRecord& rec,
                         Cartesian3& _albedo, Ray& scattered, double& proDenF) const override;

    double scattering_proDenF(const Ray& ray_in, const HitRecord& rec, const Ray& scattered) const;
public:
...
public:
    ...
    virtual bool scatter(const Ray& ray_in, HitRecord& rec, Cartesian3& attenuation,
                         Ray& scattered, double& proDenF) const override;
